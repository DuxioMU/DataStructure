...
public class MainPrim {
	...
	//测试实现的两种Prim算法的性能差距
	//使用索引堆实现的Prim算法优于Lazy Prim算法
	public static void main(String[] args) {
		String filename1 = "Primtest/testG1.txt";
        int V1 = 8;

        String filename2 = "Primtest/testG2.txt";
        int V2 = 250;

        String filename3 = "Primtest/testG3.txt";
        int V3 = 1000;

        String filename4 = "Primtest/testG4.txt";
        int V4 = 10000;
