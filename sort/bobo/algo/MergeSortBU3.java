...
public class MergeSortBU3 {
    ...
    public static void main(String[] args) {
        ...
        // Merge Sort BU 3 也是一个O(nlogn)复杂度的算法，虽然只使用两重for循环
        // 所以，Merge Sort BU 3 也可以在1秒之内轻松处理100万数量级的数据
        // 注意：不要轻易根据循环层数来判断算法的复杂度，Merge Sort BU 3 就是一个反例
